...
Строит прогноз денежного потока на 30/60/90 дней с доверительными коридорами
по проценту отклонения и поимёнными флагами рисков. Выдаёт результат в двух
частях: краткая сводка в чат и XLSX-книга для скачивания.
