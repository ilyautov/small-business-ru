...
name: crm-cleanup
description: >
  Сканирует CRM на зависшие сделки, дубли контактов и незаполненные поля, затем
  чинит то, что собственник одобрил. Принимает необязательный аргумент области:
  сделки, контакты или всё. Триггеры: "почисти CRM", "наведи порядок в CRM",
  "проверь дубли", "почисти зависшие сделки".
