...
list-org по одной компании дали РАЗНЫЕ цифры (арбитраж 535 vs 1478 — разная методология
...
**Круговая сверка (проверено): суды дали 4 РАЗНЫЕ цифры** — checko 535, saby 1005, list-org 1478 (разная методология подсчёта дел/эпизодов). А ФССП (6 исп. производств) и выручка-2024 (544,6 млрд) совпали у всех → надёжный сигнал.
...
## Рабочий процесс (двухскоростной)
